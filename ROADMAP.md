...
- [x] **Chain composer + exploit artifact + session wizard + `csrf_prove`/`mass_assignment`/`exposure_hunt`/`upload_fuzz`/`xss_hunt`/`idor_enum`/`host_header_hunt`/`recon_full` (2026-09-22 → 2026-09-23)**
