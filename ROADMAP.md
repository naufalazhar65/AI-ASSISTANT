...
- [x] **Chain composer + exploit artifact + session wizard + `csrf_prove`/`mass_assignment`/`exposure_hunt`/`upload_fuzz`/`xss_hunt` (2026-09-22 → 2026-09-23)**
...
- Pedoman & scope: `SECURITY.md`. **Total tools 309** · **CORE 128** · **84 playbook** · vitest 401.
