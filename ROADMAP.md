...
- [x] **White-box & playbooks** (adaptasi Strix, Apache-2.0): `sast_scan` (semgrep) + `security_playbook` (**68 pack** / 9 kategori: analysis, vulnerabilities ×26, tooling, protocols, frameworks, technologies, cloud, reconnaissance, custom) + `apps/web/security-playbooks/`
