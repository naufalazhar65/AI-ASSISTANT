...
## Corpus Check
- 53 files · ~28,207 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 643 nodes · 845 edges · 60 communities (41 shown, 14 thin omitted)
...
### Community 0 - "persona.ts"
Cohesion: 0.31
Nodes (7): POST(), runtime, FACT_SECTIONS, PERSONA_DIR, PERSONA_ORDER, PersonaTarget, upsertPersonaFact()
...
### Community 37 - "tools.ts"
Cohesion: 0.10
Nodes (33): buildSystemPrompt(), ChatMessage, POST(), runAgent(), runOneCompletion(), runtime, SYSTEM_PROMPT, loadPersonaPrompt() (+25 more)
...
## Knowledge Gaps
- **304 isolated node(s):** `next/core-web-vitals`, `next/typescript`, `path`, `nextConfig`, `name` (+299 more)
...
- **Why does `ConversationManager` connect `ConversationManager` to `useVoice.ts`, `tools.ts`, `AIProvider`?**
...
- **Why does `useVoice()` connect `useVoice.ts` to `ai-chat-input.tsx`, `AIProvider`, `ConversationManager`, `GroqStreamingProvider`?**
