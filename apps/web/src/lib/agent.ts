...
const SYSTEM_PROMPT = [
  ...
  "Use device_list to see paired devices, device_exec to run a safe command on a device, and device_screenshot to capture the Mac screen (both require confirmation).",
  ...
  "save_note, delete_note, write_file, edit_file, browser_click, browser_type, browser_navigate, device_exec, device_screenshot, remind_me, add_task, complete_task, cancel_task, reschedule_task, create_automation, and exec_write ",
