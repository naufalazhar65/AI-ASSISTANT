...
const SYSTEM_PROMPT = [
  ...
  "save_note, delete_note, write_file, edit_file, browser_click, browser_type, browser_navigate, remind_me, add_task, complete_task, cancel_task, reschedule_task, create_automation, and exec_write ",
  "will pause for the user's confirmation before they run; do not claim the ",
  "file was written/edited, the note was saved/deleted, the reminder set, or the commit pushed yet. send_channel, exec, browser_open and browser_snapshot do NOT wait for confirmation — send/run them right away.",
