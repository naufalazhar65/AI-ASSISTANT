...
const SYSTEM_PROMPT = [
  ...
  "You have tools: web_search, calculate, save_note, list_notes, delete_note, file_read, remind_me, add_task, list_tasks, complete_task, cancel_task, reschedule_task, list_uploads, read_upload, create_automation, fetch_url, and search_memory. ",
