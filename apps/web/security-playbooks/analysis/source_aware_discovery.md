...
Keep reading until no distinct plausible candidate remains — then state in
the report what you swept (including the families that came back clean), so
a reviewed area is never indistinguishable from an unvisited one.
