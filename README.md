...
[![Tools](https://img.shields.io/badge/tools-223-ff69b4?style=flat-square)](./apps/web/src/lib/tools.ts)
...
| **Security — bug bounty** | `scope_import`, `recon_diff`, `recon_screenshot`, `crawl`, `content_discover`, `param_discover`, `param_fuzz`, `oast_create/poll/stop`, `http_session`, `bola_diff`, `jwt_attack`, `evidence_capture` | Scope parsing, new-asset diff, visual recon, crawler, hidden-param discovery, param fuzzing, OOB/blind proof, multi-identity authz, JWT forge/crack, report evidence |
