...
[![Tools](https://img.shields.io/badge/tools-218-ff69b4?style=flat-square)](./apps/web/src/lib/tools.ts)
...
| **Security — bug bounty** | `oast_create/poll/stop`, `http_session`, `bola_diff`, `content_discover`, `param_fuzz`, `jwt_attack`, `evidence_capture` | OOB/blind proof, multi-identity authz (BOLA/IDOR), content discovery, param fuzzing (XSS/SQLi/SSTI/redirect), JWT forge/crack, report evidence |
